...
<ur>
  ...
  <li>!! 다른 페이지에서도 로그인 상태가 이어질 수 있도록 해야함... 글 작성하게 하려고 했는데 로그인 상태가 이어지지 않아서 일단 내일 더 도전해봐야 할 듯</li>
</ur>
...
<ur>
  ...
  <li><a href="Writing" class="page">글 작성 페이지</a>지역 추가 버튼 이벤트 추가 (추가 버튼 클릭 시 선택한 지역 표시하기) [25.02.20]</li>
  <li>!! 해야할 일 !! : 현재 글 작성 가능한 지역 늘리기(테스트 용으로 5개 이하, 여러지역으로), 추가 버튼 중복 방지 이벤트 생성, 여행 지역 텍스트 크기 등 수정, 지역 삭제 고민 및 생성</li>
</ur>

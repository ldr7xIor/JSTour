...
<ur>
  ...
  <li>reviewDetail 페이지에 댓글 기능 추가 및 마이페이지에서 내가 쓴 댓글 확인 가능 [25.02.27]</li>
  <li><a href="Local" class="page">reviewDetail 페이지에</a> 댓글을 작성하면 댓글을 작성한 해당 글에서만 보이고 내가 쓴 댓글에도 뜨며 댓글을 누르면 원글로 이동함 [25.02.28]</li>
</ur>

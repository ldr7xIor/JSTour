...
<ur>
  ...
  <li><a href="Writing" class="page">글 작성 페이지</a> 지역 추가 버튼 이벤트 초기 설정 [25.02.17]</li>
  <li>!! 해야할 일 !! : 현재 글 작성 가능한 지역 늘리기(테스트 용으로 5개 이하, 여러지역으로), 추가 버튼 이벤트 생성, 지역 삭제 고민 및 생성, 글작성 페이지에서 '목록으로' 버튼 생성</li>
</ur>
